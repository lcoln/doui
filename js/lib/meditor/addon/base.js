...
define(['lib/layer/base'], function(){
    ...
    ME.addon = {
        ...
        table: function(elem, vm){
            var offset = yua(elem).offset();
                // cont = '<li>' + repeat('<span></span>', 10) + '</li>';
            // cont = repeat(cont, 10)
            layer.open({
                type: 7,
                title: '0行 x 0列',
                ...
                shadeClose: true,
                offset: [offset.top + 37, 'auto', 'auto', offset.left],
                matrix: [objArr(10),objArr(10),objArr(10),objArr(10),objArr(10),objArr(10),objArr(10),objArr(10),objArr(10),objArr(10)],
